...
UBUNTU_TRANSLATION_DOMAIN="qtgram-ubuntu.mzanetti"
...
aptest.commands = bash $$PWD/QtGram-ubuntu/tests/autopilot/run
aptest.depends  = sub-QtGram-ubuntu

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/QtGram-ubuntu/tests/unit
unittest.depends  = sub-QtGram-ubuntu
